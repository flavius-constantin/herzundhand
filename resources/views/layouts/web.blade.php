                        ...
                        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
                            <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                                <div class="flex items-center justify-between w-full md:w-auto">
                                    <a href="{{ route('home') }}">
                                        <img class="h-8 w-auto sm:h-10" src="{{ asset('logo.jpg') }}" alt="{{ config('app.name') }} " />
                                    </a>
                        ...
                        <div class="rounded-lg shadow-md">
                            <div class="rounded-lg bg-white shadow-xs overflow-hidden">
                                <div class="px-5 pt-4 flex items-center justify-between">
                                    <div>
                                        <img class="h-8 w-auto" src="{{ asset('logo.jpg') }}" alt="{{ config('app.name') }} " />
                                    </div>
                                    <div class="-mr-2">
    ...
    <footer class="bg-gray-900 text-center text-gray-400 text-sm py-2" role="contentinfo">
        <div id="kontakt" class="flex justify-between">
            ...
            <p class="w-1/2">
                ...
                &bull;
                <a href="#" title="Datenschutz" class="text-gray-400 hover:text-green-600">Datenschutz</a>
            </p>
        </div>
