            ...
            <form wire:submit.prevent="store" class="mb-12">
                <div class="flex flex-wrap mb-6 -mx-3">
                    <div class="w-full md:w-1/2 mb-6 md:mb-0 px-3">
                        ...
                        <input
                            ...
                            placeholder="Max"
                            name="first_name"
                            class="block w-full bg-gray-200 text-gray-700 border shadow rounded-lg focus:outline-none focus:bg-white focus:border-gray-500 mb-2 px-4 py-3"
                        >
                        @error('first_name')
                ...
                <div class="w-full mb-6">
                    ...
                    <textarea
                        ...
                        rows="4"
                        name="message"
                        class="block w-full border shadow rounded-lg appearance-none bg-gray-200 text-gray-700 focus:outline-none focus:bg-white focus:border-gray-500 mb-2 px-4 py-3"
                ...
                <div class="flex justify-between items-center w-full">
                    ...
                    <div>
                        ...
                        <button
                            ...
                            wire:loading.class="bg-green-600 cursor-wait"
                            class="inline-flex items-center justify-center py-3 px-4 border border-transparent text-xs uppercase font-bold rounded-full text-green-600 hover:text-white bg-green-200 hover:bg-green-600 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out cursor-pointer"
                        >
